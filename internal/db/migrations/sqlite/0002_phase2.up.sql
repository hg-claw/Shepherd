...
INSERT INTO settings(key, value) VALUES
 ...
 ('file_sandbox_paths',             '/tmp' || char(10) || '/var/log' || char(10) || '/etc/shepherd' || char(10) || '/etc/shepherd-xray' || char(10) || '/etc/shepherd-singbox' || char(10) || '/etc/shepherd-mieru' || char(10) || '/etc/systemd/system' || char(10) || '/Library/LaunchDaemons' || char(10) || '/usr/local/bin' || char(10) || '/home' || char(10) || '/Users' || char(10) || '/opt' || char(10) || '/srv'),
