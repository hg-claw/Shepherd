        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="text-left">
              <th className="px-3 py-2 text-left align-middle font-medium text-2xs uppercase tracking-[0.05em] text-muted-foreground">{t('xray.events.time', 'Time')}</th>
              <th className="px-3 py-2 text-left align-middle font-medium text-2xs uppercase tracking-[0.05em] text-muted-foreground">{t('xray.events.action', 'Action')}</th>
              <th className="px-3 py-2 text-left align-middle font-medium text-2xs uppercase tracking-[0.05em] text-muted-foreground">{t('xray.events.host', 'Host')}</th>
              <th className="px-3 py-2 text-left align-middle font-medium text-2xs uppercase tracking-[0.05em] text-muted-foreground">{t('xray.events.result', 'Result')}</th>
            </tr>
          </thead>
          <tbody>
            {rows.length === 0 ? (
              <tr><td colSpan={COLS} className="px-3 py-6 text-center text-sm text-muted-foreground">{t('xray.empty.events', 'No events yet.')}</td></tr>
            ) : (
              <>
